const plans = [
  ...
  { name: 'Pro', price: '$12', period: '/user/mo', desc: 'For growing teams', features: ['Unlimited projects', 'Unlimited members', 'Sprint analytics', 'AI insights', 'Priority support', 'GitHub integration'], cta: 'Start Free Trial', featured: true },
