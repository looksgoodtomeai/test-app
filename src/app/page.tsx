  ...
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '64px 24px' }}>
      ...
      <div style={{ display: 'flex', gap: 16 }}>
        <a href="/pricing" style={{ background: '#6c63ff', color: '#fff', padding: '14px 32px', borderRadius: '8px', textDecoration: 'none', fontWeight: 600 }}>
          Start Free Trial
        </a>
        <a href="/about" style={{ border: '2px solid #6c63ff', color: '#6c63ff', padding: '14px 32px', borderRadius: '8px', textDecoration: 'none', fontWeight: 600 }}>
          Learn More
        </a>
      </div>
